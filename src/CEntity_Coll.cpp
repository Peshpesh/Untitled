...
int CEntity::getVertDeflect(const double& NewX, const double& NewY) {
...
int CEntity::CollGround(const int& collID, const int& X_offset, const int& Y_offset) {
...
bool CEntity::CollEntity(CEntity* Entity, const SDL_Point& tl, const SDL_Point& br) {
	if (this == Entity || Entity == NULL) return false;
	if (/*Entity->Flags & ~ENTITY_FLAG_MAPONLY && */Entity->Collides(tl, br)) {
...
bool CEntity::CollTile(const SDL_Point& tilepos, const SDL_Point& tl, const SDL_Point& br) {
...
bool CEntity::CollTile_top(const int& collID, const SDL_Point& tilepos, const SDL_Point& tl, const SDL_Point& br) {
...
bool CEntity::CollTile_bot(const int& collID, const SDL_Point& tilepos, const SDL_Point& tl, const SDL_Point& br) {
