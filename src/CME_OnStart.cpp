...
bool CMapEdit::OnStart()
{
	...
	if ((Map_Interface = CSurface::OnLoad("../res/editor/interface.png", Map_Renderer)) == NULL)
	{
		return false;
	}
	...
	if ((CME_NPC::NPCControl.NPC_Tileset = CSurface::OnLoad(Entity_Path, Map_Renderer)) == NULL)
	{
		return false;
	}

	if ((CME_NPC::NPCControl.NPC_Common = CSurface::OnLoad("../res/npc/common.png", Map_Renderer)) == NULL)
	{
		return false;
	}
